...
const Women = () => {
  ...
  useEffect(() => {
    const WomenProducts = [
      ...AccEquipAPI.filter((product) => product.gender === "women"),
      ...FootballAPI.filter((product) => product.gender === "women"),
      ...HoodiesSweatshirtAPI.filter((product) => product.gender === "women"),
      ...ShoesStoreCardAPI.filter((product) => product.gender === "women"),
      ...SNKRAPI.filter((product) => product.gender === "women"),
      ...TrousersTigthsAPI.filter((product) => product.gender === "women"),
    ];

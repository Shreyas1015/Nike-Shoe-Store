...
const Men = () => {
  ...
  useEffect(() => {
    const menProducts = [
      ...AccEquipAPI.filter((product) => product.gender === "men"),
      ...FootballAPI.filter((product) => product.gender === "men"),
      ...HoodiesSweatshirtAPI.filter((product) => product.gender === "men"),
      ...ShoesStoreCardAPI.filter((product) => product.gender === "men"),
      ...SNKRAPI.filter((product) => product.gender === "men"),
      ...TrousersTigthsAPI.filter((product) => product.gender === "men"),
    ];
